...
if (isset($_GET['hotelid'])){
  ...
  $query = "SELECT * FROM hotel WHERE Hotel_ID = '$hID'";
  $query2 = "SELECT * FROM phone_hotel WHERE Hotel_ID_phone = '$hID'";
  $query3 = "SELECT * FROM email_hotel WHERE Hotel_ID_email = '$hID'";
  ...
  echo '<html>';
  echo '<head>';
  echo '<title>Hotel Contact Info</title>';
  ...
  echo "<h2>Contact Info for ".$row['Name_H']."</h2>";
  ...
  if (mysqli_num_rows($results) == 0){
    ...
    echo "<td>".$row['A_Street_H']."</td>";
    echo "<td>".$row['A_Number_H']."</td>";
    echo "<td>".$row['A_Postal_Code_H']."</td>";
    echo "</tr>\n";
